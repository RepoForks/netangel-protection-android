...
*/
    ...
    public synchronized static void addStateListener(StateListener sl) {
        if (!stateListener.contains(sl)) {
            ...
            if (mLaststate != null)
                sl.updateState(mLaststate, mLaststatemsg, mLastStateresid, mLastLevel, mLastLevel);
        }
    }
    ...
    public synchronized static void updateStateString(String state, String msg, int resid, ConnectionStatus level) {
        ...
        ConnectionStatus prevLevel = mLastLevel;
        mLaststate = state;
        mLaststatemsg = msg;
        ...
        for (StateListener sl : stateListener) {
            sl.updateState(state, msg, resid, level, prevLevel);
        }
